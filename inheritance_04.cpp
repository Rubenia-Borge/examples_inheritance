...
* They happen because the derived class wants to access data members or functions
* that are declared as private. That is not possible. Only public and protected class
